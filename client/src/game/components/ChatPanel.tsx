    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute top-full right-0 mt-1 w-64 h-72 bg-gray-900/95 backdrop-blur-sm border border-gray-700/50 rounded-2xl shadow-2xl flex flex-col overflow-hidden z-50">
