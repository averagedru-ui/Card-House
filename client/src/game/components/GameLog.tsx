...
export const GameLog: React.FC = () => {
  ...
  return (
    <div className="bg-gray-900/80 backdrop-blur-sm rounded-xl border border-gray-700/50 overflow-hidden">
      <div className="px-3 py-1.5 bg-gray-800/80 border-b border-gray-700/50">
        <span className="text-gray-400 text-xs font-semibold uppercase tracking-wider">Activity</span>
      </div>
      <div
        ref={scrollRef}
        className="max-h-32 md:max-h-48 overflow-y-auto p-2 space-y-0.5 scrollbar-thin scrollbar-thumb-gray-700"
      >
