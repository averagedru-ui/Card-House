  ...
  return (
    <div className="relative">
      <button
        ...
        className="w-8 h-8 bg-gray-800 active:bg-gray-700 rounded-xl flex items-center justify-center border border-gray-700/50"
      >
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="absolute top-full right-0 mt-1 w-56 bg-gray-900/95 backdrop-blur-sm rounded-2xl border border-gray-700/50 overflow-hidden shadow-2xl z-50"
          >
